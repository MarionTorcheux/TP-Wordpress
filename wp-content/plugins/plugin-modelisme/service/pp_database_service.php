...
class PP_database_service
{
    ...
    public static function create_db()
    {
        ...
        if ($count_adherent == 0)
        {
            $wpdb->query(" INSERT INTO {$wpdb->prefix}pp_adherent (nom, prenom, email, telephone, adresse, numero_adherent, club_ID) VALUES ('Fripouille', 'Cyrielle', 'cyrielle@gmail.com', '0468957845', '47 avenue des fripouilles','01213115861',2), ('LaGalette', 'Marion', 'bagnole@gmail.com', '0645987453','19 av jules','056546541',1),    ('Jaime', 'laGalette', 'eau@gmail.com', '0698778954','45 rue des hiboux','0546545614',3), ('Jean', 'deLaFontaine', 'vavite@gmail.com', '0696987854','89 avenue des vaches','02455565',1);");
